...
tableau_utils::Circuit SparsePauliString::reduce(bool z = true) const {
    SparseTableau tableau = SparseTableau(num_qubits, std::vector<SparsePauliString>{*this});
...
tableau_utils::Circuit SparsePauliString::transform(SparsePauliString const &p) const {
    tableau_utils::Circuit c1 = reduce();
    tableau_utils::Circuit c2 = conjugate_circuit(p.reduce());
