...
Eigen::Matrix2cd MatrixProductState::zero_projector() {
	Eigen::Matrix2cd P;
	P << 1, 0, 0, 0;
	return P;
}

Eigen::Matrix2cd MatrixProductState::one_projector() {
	Eigen::Matrix2cd P;
	P << 0, 0, 0, 1;
	return P;
}
...
void MatrixProductState::measure_propagate(uint32_t q, const Eigen::Matrix2cd& proj) {
	evolve(proj, q);
